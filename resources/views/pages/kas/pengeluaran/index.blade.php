...
@section('content')
    <div class="container-fluid" style="margin: 0; padding: 0;">
        ...
        <div class="row d-flex align-items-center">
            <div class="col-md-6">
                <p class="h5 pt-4 pb-3 pl-4 text-dark font-weight-bold text-start">Pengeluaran Keuangan</p>
            </div>
            <div class="col-md-6 d-flex align-items-center justify-content-end">
                <i class="h2 bi bi-house text-primary pt-2 mr-3"></i>
                <p class="text-dark pt-2 mt-2">/ Kas Keuangan /</p>
                <p class="text-primary pt-2 ml-2 mr-4 mt-2">Pengeluaran</p>
            </div>
        </div>
        ...
        <div class="row mx-5 mb-5">
            <div class="card col-md-12">
                <div class="card-body">
                    <div>
                        <p class="h5 card-title text-center font-weight-bold text-black mb-4 mt-2">Pengeluaran Kas Operasional Perusahaan</p>
                        <form class="mr-4 ml-4" action="{{ route('pengeluaran.store') }}" method="POST" enctype="multipart/form-data" onsubmit="return validateForm()">
                            @csrf
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-10">
                                    <input type="text" class="form-control" id="nama_penerima" placeholder="Masukkan nama" name="nama_penerima" aria-describedby="nama_penerima" required pattern="[A-Za-z\s]+">
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <label for="nama_pengirim" class="col-md-2 col-form-label">Nama Pengirim</label>
                                <div class="col-md-10">
                                    <input type="text" class="form-control" id="nama_pengirim" placeholder="Masukkan nama" name="nama_pengirim" aria-describedby="nama_pengirim" required pattern="[A-Za-z\s]+">
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <label for="rupiah" class="col-md-2 col-form-label">Nominal Pengeluaran</label>
                                <div class="col-md-4">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-10">
                                    <textarea class="rounded form-control" name="keterangan" id="keterangan" cols="98" rows="6" placeholder="Masukkan deskripsi" required></textarea>
                                </div>
                            </div>
                            <div class="mb-3 row">
    ...
    @push('script')
        <script>
            function validateForm() {
                ...
                if (nama_pengirim.trim() !== "" && nama_penerima.trim() !== "" && rupiah.trim() !== "" && tanggal.trim() !==
                    "" &&
                    keterangan.trim() !== "") {
                    if (rupiah == "Rp. 0") {
                        Swal.fire({
